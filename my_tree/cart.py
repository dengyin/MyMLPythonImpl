...
if __name__ == '__main__':
    ...
    X, y = make_classification(n_features=5, n_informative=5, n_redundant=0, random_state=2019, n_classes=3)
    cart = DecisionTreeClassifier(max_depth=20)
    cart.fit(X, y)

    from sklearn.metrics import accuracy_score

    print(cart._depth)
    print(accuracy_score(y, cart.predict(X)))
